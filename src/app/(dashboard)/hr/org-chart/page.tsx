  ...
  return (
    <div>
      <PageHeader
        ...
        descriptionEn="Simple tree from manager relationships — swap for a canvas view when you scale."
        descriptionAr="شجرة بسيطة من علاقات المدير — يمكن استبدالها بعرض مرن لاحقاً."
      />
